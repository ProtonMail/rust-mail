...
use crate::{
    CryptoClock, PGPProvider, PGPProviderAsync, PGPProviderSync, SessionKeyAlgorithm, UnixTimestamp,
};
use std::sync::Arc;
...
impl PGPProviderSync for GoPGPProvider {
    ...
    fn private_key_export_unlocked(
        &self,
        private_key: &Self::PrivateKey,
        encoding: crate::crypto::DataEncoding,
    ) -> crate::Result<impl AsRef<[u8]>> {
...
impl From<crate::DataEncoding> for gopenpgp_sys::DataEncoding {
    fn from(val: crate::DataEncoding) -> Self {
        match val {
            crate::DataEncoding::Armor => gopenpgp_sys::DataEncoding::Armor,
            crate::DataEncoding::Bytes => gopenpgp_sys::DataEncoding::Bytes,
            crate::DataEncoding::Auto => gopenpgp_sys::DataEncoding::Auto,
        }
    }
}
