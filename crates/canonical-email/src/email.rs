...
#[cfg(feature = "uniffi")]
uniffi::custom_newtype!(CanonicalEmail, String);

impl proton_sqlite3::rusqlite::types::ToSql for CanonicalEmail {
    fn to_sql(
        &self,
...
impl proton_sqlite3::rusqlite::types::FromSql for CanonicalEmail {
    fn column_result(
