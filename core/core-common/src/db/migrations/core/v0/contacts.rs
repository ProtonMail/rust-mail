    ...
    block_on(async {
        ...
        tx.execute(
            ...
            CREATE TABLE contact_emails (
                ...
                CONSTRAINT constraint_contact_emails_local_cid
                    FOREIGN KEY (local_contact_id)
                    REFERENCES contacts (local_id)
                    ON DELETE CASCADE

                CONSTRAINT constraint_contact_emails_remote_cid
        ...
        tx.execute(
            ...
            CREATE TABLE contact_cards (
                ...
                CONSTRAINT constraint_contact_cards_local_cid
                   FOREIGN KEY (local_contact_id)
                   REFERENCES contacts (local_id)
                   ON DELETE CASCADE

                CONSTRAINT constraint_contact_cards_remote_cid
                   FOREIGN KEY (remote_contact_id)
                   REFERENCES contacts (remote_id)
                   ON DELETE CASCADE
            )
        ...
        tx.execute(
            ...
            CREATE TABLE contact_email_labels (
                ...
                CONSTRAINT constraint_contact_label_cid
                    ...
                    REFERENCES contact_emails (local_id)
                    ON DELETE CASCADE
            )
        ",
            vec![],
