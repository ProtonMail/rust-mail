...
impl<'c> CoreSqliteConnectionImpl<'c> {
    /// Creates or updates the DB with the provided address.
    ///
    /// # Errors
    ...
    /// Creates or updates the DB with the provided addresses.
    ///
    /// # Errors
    /// Returns an error if the DB transaction fails.
...
VALUES (?,?,?,?,?,?,?,?,?,?);
    ...
    /// Updates the DB with the provided address.
    ///
    /// # Errors
    /// Returns an error if the DB transaction fails.
    ...
    /// Updates the DB with the provided addresses.
    ///
    /// # Errors
    /// Returns an error if the DB transaction fails.
...
VALUES (?,?,?,?,?,?,?,?,?,?);
    ...
    /// Returns the address with the provided id from the DB.
    ///
    /// # Errors
    /// Returns an error if the DB transaction fails.
    ...
    /// Deletes the address with the provided id from the DB.
    ///
    /// # Errors
    /// Returns an error if the DB transaction fails.
    ...
    /// Deletes the addresses with the provided IDs.
    ///
    /// # Errors
    /// Returns an error if the DB transaction fails.
