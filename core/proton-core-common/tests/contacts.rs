...
async fn test_contact_load_public_address_keys() {
    ...
    let keys = user_ctx
        .public_address_keys_from_contacts(&pgp_provider, &unlocked_user_keys, &contact_email)
        .await
...
pub const VCARD_SIGNATURE: &str = "-----BEGIN PGP SIGNATURE-----\nVersion: ProtonMail\n\nwrsEARYKAG0FgmZqxXwJkDicqBtFkGUZRRQAAAAAABwAIHNhbHRAbm90YXRp\nb25zLm9wZW5wZ3Bqcy5vcmdAuecdczdBwpBwd5k7jTo69/49tYixORzjCzns\nzOpnqRYhBOZJEArPLqrMMxX8fzicqBtFkGUZAADF7gD/fpZ8l6pFLH5z8Tqu\nMF4msCs6qJNPFcLF5CgAc9dayp4BALsXOEW/SNnAneO5t10/DLgooWT85Opa\nHsaFPBvJ36wN\n=+GIe\n-----END PGP SIGNATURE-----\n";
