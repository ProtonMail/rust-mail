...
<<<<<<< HEAD:mail/test-utils/src/message_body.rs
...
//     settings
// }
>>>>>>> 10beae2a (Moved test contexts and their implementation to a separate crate.):mail/mail-common/tests/common/message_body.rs
