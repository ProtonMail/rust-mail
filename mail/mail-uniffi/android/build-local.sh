...
#
# ./crates/mail-uniffi/android/build-local.sh
set -eo pipefail


# Build code
rust-build/build_android.sh proton-mail-uniffi ./crates/mail-uniffi/uniffi.toml ./crates/mail-uniffi/android/lib/src/main/
# Build archive
./crates/mail-uniffi/android/build-android-archive.sh
rm -rf /tmp/rust-builds
mkdir /tmp/rust-builds/
# Copy artifacts
cp ./crates/mail-uniffi/android/lib/build/outputs/aar/lib-release.aar /tmp/rust-builds/
# Pubish
