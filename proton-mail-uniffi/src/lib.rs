...
//! [`mail::MailContext::new_login_flow`] or by using an existing session with
//! [`mail::MailContext::user_context_from_session`]. You now have access to all the labels and
